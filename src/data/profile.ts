export const profile = {
  ...
  positioning:
    'I build governed, human-in-the-loop agentic AI, document-intelligence, predictive ML, and MLOps systems for healthcare and insurance.',
  seoTitle: 'Shailesh Dudala — Senior Applied AI Engineer',
  seoDescription:
