...
export const projects: Project[] = [
  ...
  },
  {
    ...
    maturity: 'archived experiment',
    tier: 'featured',
    featured: true,
    statusNote: 'Historical archived experiment; not betting advice',
    summary:
      'Sports analytics forecasting and backtesting lab using 25+ years of historical NFL data, Elo baselines, XGBoost, logistic regression, ensembles, calibration, backtesting, and Kelly-style allocation experiments.',
    ...
    validation: ['README reports held-out season metrics including accuracy and Brier score.', 'Backtesting evaluates historical outcomes.', 'Archive status is explicit.'],
  ...
  },
  {
    ...
    tier: 'archive',
    featured: false,
    statusNote: 'Archive-tier dashboard starter',
    summary: 'Early Streamlit dashboard scaffold kept as archive/foundation evidence.',
    problem: 'The repo appears to be a simple Streamlit template, so it is not featured.',
