...
- Public artifact SHA-256: `69A5B93EB170DE1B802384BAD4E21A36EA366A5F8F8F5F9F9E6CDD0384AD757E`.
- Public artifact origin: reproducibly generated by `scripts/generate-v23-resume.py` from the V2.3 governed career and claim record.
- Public artifact status: approved for isolated V2.3 staging after one-page Letter render inspection, ATS text extraction, link review, deterministic-regeneration proof, and banned-content validation. Production and mirror verification remain a cutover-phase task.
